...
public class ZkConfigSaver {
	public static String CONF_DIR = "c:/zookeeper-3.4.6/conf/";	//目录：本地配置将会下载到此目录
	public static final String CONF_ENCODING = "UTF-8";
	public static String ZK_CONFIG_ROOTNODE = "/c:/zookeeper-3.4.6/conf/";	//目录：远程配置服务文件夹
	...
	private static final void loadProperties() {
		...
		CONF_DIR = props.getProperty("ZK_DOWNLOAD_DIR");
